...
export const en = {
  ...
  disabledHint: 'Downgrade the harness to a supported version or wait for a compatible plugin release, then restart. See the dsh startup log for details.',
  intro:
...
export const zh: Record<TemplateDemoKey, string> = {
  ...
  disabledHint: '请将 harness 降级到受支持的版本，或等待与该 harness 兼容的插件版本后重启。详见 dsh 启动日志。',
